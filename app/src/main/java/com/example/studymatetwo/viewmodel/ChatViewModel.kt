...
import com.example.studymatetwo.repositoryImpl.ChatRepositoryImpl
...
@HiltViewModel
class ChatViewModel @Inject constructor(private val repository: ChatRepositoryImpl) : ViewModel() {
